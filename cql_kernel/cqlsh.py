...
if is_win and sys.version_info < (3, 3):
    codecs.register(lambda name: codecs.lookup(UTF8) if name == CP65001 else Amanda)
...
from cqlshlib_cql_kernel import cql3handling, cqlhandling, pylexotron, sslhandling, cqlshhandling
